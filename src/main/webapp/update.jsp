...
<body >
		...
		<form action="update" method="post">
			...
			<tr>
				...
				<td><input type="text" placeholder="yyyy-mm-dd"  name="t3" ><br><br></td>
			<tr>
				<td><b>Check-out Date</b></td>
				<td><input type="text" placeholder="yyyy-mm-dd" name ="t4"><br><br></td>
			</tr>
				</table>
				<br><br>
				<button id="Submit" name="action" value="update">update your room</button>&nbsp&nbsp&nbsp&nbsp
